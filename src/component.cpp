...
namespace malt
{
    ...
    component* add_component(size_t c_id, entity e)
    {
        return impl::add_component(c_id, e);
    }

    component* get_component(const char* comp_type_name, entity e)
    {
        return impl::get_component(hash_c_string(comp_type_name, strlen(comp_type_name)), e);
    }

    component* get_component(size_t c_id, entity e)
    {
        return impl::get_component(c_id, e);
    }
